...
with a UNIQUE(enrollment_id, due_date, week_index), so a duplicate or parallel
run that tries to remind the same period loses the insert race and is skipped,
never double-notifying the customer.
"""
import uuid
...
from app.exceptions.base import ForbiddenException  # noqa: E402
